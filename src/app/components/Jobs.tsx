...
function TabBody({ children }: { children: React.ReactNode }): JSX.Element {
  ...
  return (
    <Fragment>
      <div className="work-body glass-bg" onScroll={handleScroll}>
        {children}
      </div>
          ...
          >
              ...
              <TabBody>
                ...
                <ul>
                  <li>
                    ...
                    <b>Python 3</b> and <b>React/TS</b> for improved
                    performance, UI/UX, security, and maintainability.
                  </li>
                  <li>
                    ...
                    <a
                      className="text-info"
                      href="https://fellowships.nypl.org"
                    >
                      NYPL Fellowships
                    </a>
                  ...
                  <li>
                    Built an AI chatbot that leverages{" "}
                    <b>Google DialogFlow CX</b> for natural language
                    understanding and <b>PaLM 2</b> for natural language
                    generation, enabling fast and easy access to employee
                    policies and resources for thousands of internal users.
                  </li>
                </ul>
            ...
            >
              <TabBody>
                ...
                <p>
                  ...
                  accurate estimation of Earth’s system parameters from
                  satellite data under Dr. Matteo Ottaviani’s guidance.
                </p>
                <ul>
                  <li>
                    Worked with astrophysicist researchers to design a retrieval
                    scheme based on a non-linear least-squares technique using
                    the <b>LMFit</b> library for Python, which{" "}
                    <b>
                  ...
                  <li>
                    Enhanced the framework’s usability and developer experience
                    by implementing autonomous error-handling algorithms and
                  ...
                  <li>
                    Authored detailed usage and program documentation adhering
                    to Google’s documentation style guide, which facilitated the
            ...
            >
              <TabBody>
                ...
                <p>
                  Delivered web applications and software solutions on{" "}
                  <b>GCP</b> while adhering to best practices.
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    following Google’s style guides to ensure a more reliable
                    and maintainable codebase.
                  </li>
                  <li>
                    Led the migration and development of NYPL Services, a web
                    app for internal research statistics, from ColdFusion to{" "}
